...
class Solution(object):
    def fourSum(self, nums, target):
        ...
        # wrong
    # def fs(self, nums, target):
    #     nums.sort()
        
    #     def travel(nums, target, path, res):
    #         if len(path) == 4:
    #             if target == 0 and path not in res:
    #                 res.append( path )
    #             return
    #         if len(nums) < 4 - len(path):
    #             return
    #         if len(nums) == 4 - len(path):
    #             if sum(nums) == target and path not in res:
    ...
    #             return
    #         travel(nums[1:], target, path, res)
    #         travel(nums[1:], target-nums[0], path+[nums[0]], res)

    #     res = []
    #     travel(nums, target, [], res)
    #     return res
